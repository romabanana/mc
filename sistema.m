...
function y = sistema(t,x)
 ...
 L0 = [
  ...
  if(big)
    ...
    F(1:2)   = k(1)*(L(1)/L0(1) - 1) * (x4_0 - x1_0);   # F14
    F(3:4)   = k(2)*(L(2)/L0(2) - 1) * (x5_0 - x4_0);   # F45
    F(5:6)   = k(3)*(L(3)/L0(3) - 1) * (x5_0 - x2_0);   # F25
    F(7:8)   = k(4)*(L(4)/L0(4) - 1) * (x8_0 - x4_0);   # F48
    F(9:10)  = k(5)*(L(5)/L0(5) - 1) * (x11_0 - x9_0);  # F911
    F(11:12) = k(6)*(L(6)/L0(6) - 1) * (x7_0 - x4_0);   # F47
    F(13:14) = k(7)*(L(7)/L0(7) - 1) * (x3_0 - x1_0);   # F13
    F(15:16) = k(8)*(L(8)/L0(8) - 1) * (x10_0 - x5_0);  # F510
    F(17:18) = k(9)*(L(9)/L0(9) - 1) * (x6_0 - x2_0);   # F26
    F(19:20) = k(10)*(L(10)/L0(10) - 1) * (x11_0 - x7_0); # F711
    F(21:22) = k(11)*(L(11)/L0(11) - 1) * (x11_0 - x10_0); # F1011
    F(23:24) = k(12)*(L(12)/L0(12) - 1) * (x8_0 - x7_0); # F78
    F(25:26) = k(13)*(L(13)/L0(13) - 1) * (x10_0 - x9_0); # F910
    F(27:28) = k(14)*(L(14)/L0(14) - 1) * (x4_0 - x3_0); # F34
    F(29:30) = k(15)*(L(15)/L0(15) - 1) * (x6_0 - x5_0); # F56
    F(31:32) = k(16)*(L(16)/L0(16) - 1) * (x11_0 - x8_0); # F811
    F(33:34) = k(17)*(L(17)/L0(17) - 1) * (x9_0 - x5_0); # F59
    F(35:36) = k(18)*(L(18)/L0(18) - 1) * (x10_0 - x6_0); # F610
    F(37:38) = k(19)*(L(19)/L0(19) - 1) * (x7_0 - x3_0); # F37
  endif
  # output
